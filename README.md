...
![BW = 2f_m](https://latex.codecogs.com/png.image?\dpi{110}%20\bg_white%20BW%20=%202f_m)
...
>
>![BW_{keying}=f_c + f_m - (f_c - f_m)](https://latex.codecogs.com/png.image?\dpi{110}%20\bg_white%20BW_{keying}=f_c%20+%20f_m%20-%20(f_c%20-%20f_m))
